...
def index():
	posts = [
		{'author': {'username':'Miguel'}, 'body': 'Flask - top!'},
		{'author': {'username':'Masha'}, 'body': 'Медведи нападают!!!'},
		{'author': {'username':'Stiven'}, 'body': 'Изучение алгоритмов моя страсть..'},
		{'author': {'username':'CHEbuRil1829'}, 'body': 'Х**Ня у ВаС тУть'}
	]
